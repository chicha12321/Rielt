...
public class EdBook_uchyotDialog2 extends JRDialog {
	...
	// Поля класса
	  ...
	  private final static String title_ed = 
	   ...
	   //  Объектная переменная для класса Книга учёта
		...
		private JTextField edCod_sotrud, edId_zayav;
	    ...
	    //  Конструктор класса
		public EdBook_uchyotDialog2(Window parent,Book_uchyot type,
	                    DBManager manager) {
	...
	cmbSotr = new JComboBox();
			...
			edId_zayav = new JTextField(10);
			edKod_usl = new JTextField(20);
		...
		private boolean constructBook_uchyot()	{
		  try {
			//System.out.print(fk_key);
				...
				type.setId_zayav(edId_zayav.getText().equals("") ? 
						null : new BigDecimal(edId_zayav.getText()));
